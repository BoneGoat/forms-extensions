/*
 * @(#)StringTransferable.java v1.0.0 November 30th 2010
 *
...
public class StringTransferable implements Transferable {
    private String sTransferString = "";
    ...
    public boolean isDataFlavorSupported(DataFlavor fl) {
        // No need to iterate the array since we only support strings
